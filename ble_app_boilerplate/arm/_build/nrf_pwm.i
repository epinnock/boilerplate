...
static uint32_t pwm_max_value, pwm_next_value[3], pwm_next_max_value, pwm_io_ch[3], pwm_running[3];
...
uint32_t nrf_pwm_init(nrf_pwm_config_t *config)
{
    ...
    switch(config->mode)
    {
        ...
        case PWM_MODE_LED_1000:  
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 6;
            pwm_max_value = 1000;
            break;
        case PWM_MODE_MTR_100:   
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 3;
            pwm_max_value = 100;
            break;
        case PWM_MODE_MTR_255:    
            ((NRF_TIMER_Type *) 0x4000A000UL)->PRESCALER = 1;
            pwm_max_value = 255;
            break;
        case PWM_MODE_BUZZER_64:  
    ...
    ((NRF_TIMER_Type *) 0x4000A000UL)->CC[3] = pwm_next_max_value = pwm_max_value;
    ...
    sd_nvic_SetPriority(TIMER2_IRQn, 3 | 0x01);
...
void TIMER2_IRQHandler(void)
{
    ...
    ((NRF_TIMER_Type *) 0x4000A000UL)->CC[3] = pwm_max_value = pwm_next_max_value;
    for(i = 0; i < pwm_num_channels; i++)
    {
        ...
        {
            ((NRF_TIMER_Type *) 0x4000A000UL)->CC[i] = pwm_next_value[i];
            if(!pwm_running[i])
            {
